<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PhotoBucket.Default" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="grid_16">
        <h2>
            Shared/Public | <a class="add_new_pet_header" href="MyPhotos.aspx">My Photos</a> | <a class="add_new_pet_header" href="MyDetails.aspx">Add a New Profile</a>
        </h2>
        <asp:Panel ID="SampleDataPromptPanel" runat="server" Visible="false">
            ...
            <p runat="server" id="PreSignInMessage" visible="false">
                In order to use this application, you will need to create an account and/or sign-in to continue. Would you like to create an account or sign-in now?</p>

<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyDetails.aspx.cs"
    Inherits="PhotoBucket.MyDetails" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PhotoBucket | Photo Details</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField runat="server" ID="PhotoThumbUrl" />
    <div class="grid_16">
        <h2>
            <a class="add_new_pet_header" href="Default.aspx">Shared/Public Photos</a> | <a class="add_new_pet_header"
                href="MyPhotos.aspx">My Photos</a> | Add a New Profile
    ...
    <div class="grid_7">
        ...
        <asp:Button ID="SaveStatsButton" runat="server" Text="Save Stats" OnClick="SaveStatsButton_Click"
            CssClass="button_100" />
            <asp:Button ID="DeletePetButton" runat="server" Text="Delete" OnClick="DeletePetButton_Click"
            CssClass="button_100" />
    </div>
    <div class="grid_9">
